...
public class RepositoryTracingAspect {
    ...
    @Pointcut("execution(* com.sr_banking.banking_project.repository.*.*(..))")
    ...
    public Object traceRepositoryMethod(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            if (args != null && args.length > 0) {
                ...
                logger.debug("Repository call: {}({}) with args: {}",
            ...
            span.setAttribute("repository.executionTimeMs", executionTime);
            span.setStatus(StatusCode.OK);

            logger.debug("Repository call completed: {}({}) in {}ms",
            ...
            logger.error("Repository call failed: {}({}) - {}",
